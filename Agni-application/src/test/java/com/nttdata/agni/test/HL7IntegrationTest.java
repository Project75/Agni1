...
public class HL7IntegrationTest {
    ...
    public void testTranslateHL7toFHIR() throws Exception {
        ...
        TransformRequest transformRequest =  new TransformRequest(mapName,GenericResourceTest.getTestPayload());
        byte[] r1Json = toJson(transformRequest);
        MvcResult result=null;String resultString =null;
        
        	//CREATE2
        result = mvc.perform(post("/fhirtranslator/v1/hl72fhir/"+mapName)
