package org.agni.microservices;

import com.nttdata.agni.microservices.MappingServer;
import com.nttdata.agni.microservices.RegistrationServer;
import com.nttdata.agni.microservices.WebServer;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (serverName.equals("registration") || serverName.equals("reg")) {
			...
			WebServer.main(args);
		} else if (serverName.equals("mapping") || serverName.equals("map")) {
			MappingServer.main(args);
		}else {
