...
public class WebServer {
	...
	public static final String MAPPING_SERVICE_URL = "http://MAPPING-SERVICE";
	...
	@Bean
	public WebMappingService mappingService() {
		return new WebMappingService(MAPPING_SERVICE_URL);
	}
	...
	@Bean
	public WebMappingController mappingController() {
		return new WebMappingController(mappingService());
	}
